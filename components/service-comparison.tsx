...
const comparisonTiers: ComparisonTier[] = [
  {
    ...
    features: [
      {
        name: "Generic Content Strategy",
        description: "One-size-fits-all content approach with minimal customization",
        included: true,
      },
      {
        name: "Basic Social Media Management",
        description: "Standard posting schedule with limited audience targeting",
        included: true,
      },
      {
        name: "Standard Analytics",
        description: "Basic reporting with minimal actionable insights",
        included: true,
      },
      {
        name: "Limited Brand Development",
        description: "Template-based brand elements with minimal personalization",
        included: true,
      },
      {
        name: "Reactive Customer Service",
        description: "Responding to issues rather than anticipating needs",
        included: true,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: "Tailored Content Strategy",
        description: "Custom content plans designed for your unique brand voice and goals",
        included: true,
      },
      {
        name: "Strategic Social Media Growth",
        description: "Data-driven posting and engagement tactics to maximize impact",
        included: true,
      },
      {
        name: "Advanced Performance Analytics",
        description: "Comprehensive insights with actionable recommendations for growth",
        included: true,
      },
      {
        name: "Comprehensive Brand Development",
        description: "Full-spectrum brand strategy with distinctive visual and verbal identity",
        included: true,
      },
      {
        name: "Proactive Strategic Partnership",
        description: "Anticipating market trends and evolving your brand accordingly",
        included: true,
      },
    ],
  },
